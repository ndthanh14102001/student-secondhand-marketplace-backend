...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    product_likes: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::product.product'
    >;
    ...
    user_followed: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    sended_notifications: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::notification.notification'
    >;
    received_notifications: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::notification.notification'
    >;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.Text;
    status: Attribute.Enumeration<['onSale', 'Sold']> &
      Attribute.DefaultTo<'onSale'>;
...
export interface ApiReportReport extends Schema.CollectionType {
  ...
  attributes: {
    type: Attribute.Enumeration<['product', 'user']>;
    product: Attribute.Relation<
      'api::report.report',
      'manyToOne',
      'api::product.product'
